...
class SparkSqlParserSuite extends AnalysisTest {
   ...
   * - CreateTable the createTime in tableDesc will replaced by -1L.
    * ableDesc中createTable的createTime将被-1L所取代
   */
