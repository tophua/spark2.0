...
class JDBCSuite extends SparkFunSuite
  ...
  before {
    ...
    //将为我们的数据库指定的额外属性,我们需要这些来测试查询中OPTIONS子句的参数使用情况
  ...
  //通过JDBC PartitioningInfo API进行分区
  ...
  //选项sessionInitStatement，运行SQL来初始化数据库会话
