...
abstract class QueryTest extends PlanTest {
   ...
   * Asserts that a given [[Dataset]] does not have missing inputs in all the analyzed plans.
    * 断言给定的[[Dataset]]在所有分析的计划中都没有缺少输入
   */
...
object QueryTest {
  ...
  //我们需要递归调用prepareRow来处理具有结构类型的模式
