...
object GeneralizedLinearRegression extends DefaultParamsReadable[GeneralizedLinearRegression] {
  ...
  /** Set of link names that GeneralizedLinearRegression supports.
    * GeneralizedLinearRegression支持的链接名称集*/
